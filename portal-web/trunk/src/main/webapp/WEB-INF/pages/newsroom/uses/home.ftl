...
<body class="newsroom">
    ...
    <article class="detail">
      ...
      <div class="content">
        ...
        <div class="usesMap">
          <img src="<@s.url value='/img/dummies/mapdummy.jpg'/>"></img>
        </div>
      </div>
    </article>
    <article class="data-use-news">
      ...
      <div class="content">
        <div class="inner clean">
          <ul>
            <li>
              <img src="<@s.url value='/img/dummies/batdummy.jpg'/>"></img>
            ...
            <li>
              <img src="<@s.url value='/img/dummies/deerdummy.jpg'/>"></img>
            ...
            <li class="last">
              <img src="<@s.url value='/img/dummies/ecodummy.jpg'/>"></img>
          ...
          <ul>
            <li>
              <img src="<@s.url value='/img/dummies/aphdummy.jpg'/>"></img>
            ...
            <li>
              <img src="<@s.url value='/img/dummies/frogdummy.png'/>"></img>
            ...
            <li class="last">
              <img src="<@s.url value='/img/dummies/bugdummy.png'/>"></img>
