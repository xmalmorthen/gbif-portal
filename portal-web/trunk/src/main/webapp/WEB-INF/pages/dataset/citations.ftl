<#if dataset.citation?has_content || (dataset.bibliographicCitations?size>0) >
<article id="references">
  ...
  <div class="content">
    ...
    <div class="left">
      <#if dataset.citation?has_content>
        <h3>Citation</h3>

        <p><#if dataset.citation.identifier?has_content><a href="${dataset.citation.identifier}">${dataset.citation.text}</a><#else>${dataset.citation.text}</#if></p>
      </#if>
