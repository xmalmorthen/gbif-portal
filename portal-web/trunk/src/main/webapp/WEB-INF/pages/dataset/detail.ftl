...
<@common.article id="taxonomic_coverage" title="Summary">
  ...
  <div class="right">
    ...
    <h3>Metadata</h3>
    <ul>
      <li class="download, placeholder_temp">EML file <a class="placeholder_temp" href="#"><abbr>[ENG]</abbr></a> &middot; <a href="#"><abbr>[SPA]</abbr></a> &middot; <a href="#"><abbr>[GER]</abbr></a></li>
      <li class="download, placeholder_temp">ISO 1939 file <a class="placeholder_temp" href="#"><abbr>[ENG]</abbr></a> &middot; <a href="#"><abbr>[SPA]</abbr></a> &middot;<a href="#"><abbr>[GER]</abbr></a></li>
    </ul>
  </div>
...
<@common.article id="legal" title="Dataset usage & legal issues" class="mono_line">
  <div class="left">
   <#if dataset.intellectualRights?has_content>
    ...
    <p>${dataset.title!"???"} (accessed through GBIF data portal, <a href="${baseUrl}/dataset/${dataset.key}" title="${dataset.title!}">${baseUrl}/dataset/${dataset.key}</a>, ${.now?date})</p>
  </div>
</@common.article>
