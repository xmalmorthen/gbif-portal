              ...
              <li>
                ...
                <div class="dropdown-menu filters">
                  ...
                  <ul>
                    ...
                    <li><a tabindex="-1" href="#" data-placeholder="Type a country name..." data-filter="PUBLISHING_COUNTRY" title="Publishing country" data-template-filter="template-simple-filter" data-template-summary="template-filter" class="filter-control" data-input-classes="">Country</a></li>
