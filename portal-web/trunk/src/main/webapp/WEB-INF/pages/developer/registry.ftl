...
<@common.article id="installations" title="Installations">
    <div class="fullwidth">
      ...
      <@api.apiTable_registry>
        ...
        <@trowI url="/{UUID}" respLink="/installation/a957a663-2f17-415f-b1c8-5cf6398df8ed">Gets details for the single installation</@trowI>
...
<@common.article id="organizations" title="Organizations">
  ...
  <@api.apiTable_registry>
    ...
    <@trowO url="/{UUID}" respLink="/organization/e2e717bf-551a-4917-bdc9-4fa0f342c530">Gets details for the single organization</@trowO>
...
<div class="fullwidth">
  ...
  <@api.apiTable_registry>
    ...
    <@trowNo url="/{UUID}/pendingEndorsement" method="GET" resp="Organization" respLink="/node/0909d601-bda2-42df-9e63-a6d51847ebce/pendingEndorsement" paging=true>Lists all organizations whose endorsement by the node is pending</@trowNo>
    ...
    <@trowNo url="/{UUID}/dataset" method="GET" resp="Dataset" respLink="/node/0909d601-bda2-42df-9e63-a6d51847ebce/dataset" paging=true>Lists datasets owned by organizations endorsed by the node</@trowNo>
    <@trowNo url="/{UUID}/installation" method="GET" resp="Installation" respLink="/node/0909d601-bda2-42df-9e63-a6d51847ebce/installation" paging=true>Lists installations hosted by organizations endorsed by the node</@trowNo>
  </@api.apiTable_registry>
...
<div class="fullwidth">
  ...
  <@api.apiTable_registry>
    ...
    <@trowNe url="/{UUID}/constituents" method="GET" resp="Dataset" respLink="/network/7ddd1f14-a2b0-4838-95b0-785846f656f3/constituents" paging=true>Lists dataset constituents of the network</@trowNe>
