...
<div class="fullwidth">
  ...
  <@api.apiTable>
    <@trowS url="/search" respLink="dataset/search?q=plant&PUBLISHING_COUNTRY=argentina" paging=true params=[7,8,9,10,11,12,13,14,15]>Full text search across all datasets.
        Results are ordered by relevance.</@trowS>
    <@trowS url="/suggest" respLink="dataset/suggest?q=Amazon&dataset_type=OCCURRENCE" params=[7,8,9,10,11,12,13,14,15]>Search that returns up to 20 matching datasets.
        Results are ordered by relevance.</@trowS>
  </@api.apiTable>
...
<@common.article id="installations" title="Installations">
    <div class="fullwidth">
      ...
      <@api.apiTable_registry>
        <@trowI url="" respLink="/installation" paging=true params=[1,5,6]>Lists all installations</@trowI>
...
<@common.article id="organizations" title="Organizations">
  ...
  <@api.apiTable_registry>
    <@trowO url="" respLink="/organization" paging=true params=[1,2,5,6]>Lists all organizations</@trowO>
...
<div class="fullwidth">
  ...
  <@api.apiTable_registry>
    <@trowNo url="" respLink="/node" paging=true params=[1,5,6]>Lists all nodes</@trowNo>
...
<#assign params = {
  ...
  "country": "Filters datasets by country given as our <a href='http://builds.gbif.org/view/Common/job/gbif-api/site/apidocs/org/gbif/api/vocabulary/Country.html'>Country enum</a>, e.g. country=CANADA",
  "type (dataset type)": "Filters datasets by their dataset type given as our <a href='http://builds.gbif.org/view/Common/job/gbif-api/site/apidocs/org/gbif/api/vocabulary/DatasetType.html'>DatasetType enum</a>",
  "type (metadata type)": "Filters metadata documents by the metadata type given as our <a href='http://builds.gbif.org/view/Common/job/gbif-api/site/apidocs/org/gbif/api/vocabulary/MetadataType.html'>MetadataType enum</a>",
