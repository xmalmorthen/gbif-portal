  ...
  <article class="results light_pane">
    ...
    <div class="content">
      ...
      <div class="right">
        ...
        <div class="refine">
          <h4>DATASET TYPE</h4>
          <a href="#">Any <span class="more"></span></a>
        </div>
        ...
        <div class="download">
          ...
          <div class="dropdown">
            <a href="#" class="title" title="Download description"><span>Download metadata</span></a>
            <ul>
              <li><a href="#a"><span>Download metadata</span></a></li>
