...
<content tag="tabs">
  <ul>
    ...
    <li><a href="/member/${id!}/occurrence" title="Occurrences"><span>Occurrences</span></a></li>
...
<article>
  ...
  <div class="content">
    ...
    <div class="left">
      ...
      <p>1900 Benjamin Franklin Parkway, Philadelphia, PA 19103, United States Of America</p>
    ...
    <div class="header">
      <div class="left">
        ...
        <ul>
          ...
          <li><a href="#" id="tax_sort_occurrences" class="sort">Sort alphabetically<span class="more"></span></a></li>
        </ul>
      </div>
    </div>
    <div class="left">
