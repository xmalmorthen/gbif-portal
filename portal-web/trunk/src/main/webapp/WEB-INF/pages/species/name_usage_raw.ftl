...
<content tag="infoband">
  ...
  <h3>according to <a href="/dataset/checklist/123">Mexican felines</a> checklist</h3>
...
<content tag="tabs">
  <ul>
    <li><a href="/species/${id!}/name_usage"><span>Information</span></a></li>
    <li><a href="/species/${id!}/activity" title="Activity" id="activity_tab"><span>Activity <sup>(2)</sup></span></a>
    </li>
    <li class='selected'><a href="/species/${id!}/name_usage_raw"><span>Details</span></a></li>
  </ul>
</content>
...
<article>
  ...
  <div class="content">
    ...
    <div class="left">
      ...
      <p><a href="/dataset/checklist/123" title="Mexican Felines">Mexican Felines</a></p>

      <h3>Publisher</h3>

      <p><a href="/member/456" title="Berlin Natural Museum">Berlin Natural Museum</a></p>
    ...
    <div class="right">
      ...
      <h3>Networks</h3>
      <ul>
        <li><a href="/member/123" title="World Museums">World Museums</a></li>
        <li><a href="/member/123" title="World Museums">World Museums</a></li>
        <li><a href="/member/123" title="World Museums">World Museums</a></li>
      </ul>
      <h3>Technical partner</h3>

      <p><a href="/member/123" title="Harvard ETSUM">Harvard ETSUM</a></p>
    </div>
  </div>
  <footer></footer>
</article>
  ...
  <div class="content">
    ...
    <div class="left">
      <div class="row first odd">
        ...
        <ul>
          <li><h4>Location ID</h4>

            <div class="value">TDWG:VIE</div>
          </li>
          <li class="last"><h4>Locality</h4>
      ...
      <div class="row even">
        ...
        <ul>
          <li><h4>Location ID</h4>
            ...
            <div class="value">TDWG:CLM</div>
          </li>
          <li class="last"><h4>Locality</h4>

            <div class="value">Colombia</div>
          </li>
        </ul>
      </div>
      <div class="row last odd">
        <div class="row_number">5</div>
        <ul>
          <li><h4>Location ID</h4>

            <div class="value">TDWG:CBD</div>
          </li>
          <li class="last"><h4>Locality</h4>
      ...
      <div class="row unique odd">
        ...
        <ul>
          <li><h4>Identifier</h4>
            ...
            <div class="value"><a href="http://mantodea.speciesfile.org/Common/basic/SendBlob.aspx?ImageID=55">http://mantodea.speciesfile.org/Common/basic/SendBlob.aspx?ImageID=55</a>
            </div>
          </li>
          <li><h4>Description</h4>

            <div class="value">Holotype of Dysaulophthalma nathani female MMUE</div>
          </li>
          <li class="last"><h4>Format</h4>

            <div class="value">jpeg</div>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="row first odd">
        ...
        <ul>
          <li><h4>Title</h4>
            ...
            <div class="value">Dysaulophthalma nathani gen et sp. n. A new praying mantis from Southern India
              (Dictyoptera: Mantodea, Tarachodidae).
            </div>
          </li>
          <li><h4>Source</h4>

            <div class="value">Entomologist`s Monthly Magazine (Ent. Mon. Mag.)</div>
          </li>
          <li><h4>Creator</h4>

            <div class="value">Stewie</div>
          </li>
          <li><h4>Type</h4>
      ...
      <div class="row last even">
        ...
        <ul>
          <li><h4>Title</h4>
            ...
            <div class="value">Nuevas especies de blatidos y mantidos para Colombia (Insecta: Dictyoptera) y una
              natasobre la hembra de Vates festae Giglio-Tos, 1914.
            </div>
          </li>
          <li><h4>Source</h4>

            <div class="value">Boletin Cientifico Museo de Historia Natural Universidad de Caldas</div>
          </li>
          <li><h4>Creator</h4>

            <div class="value">Salazar</div>
          </li>
          <li><h4>Type</h4>
          ...
          <li class="last"><h4>Bibliographic citation</h4>
            ...
            <div class="value">Salazar. 2004. Nuevas especies de blatidos y mantidos para Colombia (Insecta:
              Dictyoptera) y una natasobre la hembra de Vates festae Giglio-Tos, 1914. Boletin Cientifico Museo de
              Historia Natural Universidad de Caldas 273-275
            </div>
          </li>
        </ul>
      </div>
