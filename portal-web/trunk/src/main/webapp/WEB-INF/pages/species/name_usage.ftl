...
<content tag="infoband">
  <ul class="breadcrumb">
    <li class="last"><a href="#" title="Species">Name usage</a></li>
  </ul>
...
<div class="right">
  <h3>Synonyms</h3>
  <ul class="no_bottom">
    <li><a href="<@s.url value='/species/${id!}/name_usage'/>">Felix Linnaeus</a></li>
    <li><a href="<@s.url value='/species/${id!}/name_usage'/>">Felix Mexicalis</a></li>
    <li><a href="<@s.url value='/species/${id!}/name_usage'/>">Puma Mexicalies</a></li>
  </ul>
...
<article>
  ...
  <div class="content">
    ...
    <div class="right">
      ...
      <ul>
        <li>Europe <span class="number">200</a></li>
        <li>America <span class="number">32</a></li>
        <li>Asia <span class="number">152</a></li>
      </ul>
    </div>
