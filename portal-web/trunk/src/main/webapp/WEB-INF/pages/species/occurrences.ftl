<html>
<head>
  <title>Species occurrences - GBIF</title>
...
<content tag="tabs">
  <ul>
    ...
    <li class='selected'><a href="<@s.url value='/species/${id!}/occurrences'/>" title="Occurrences"
                            id="occurrences_tab"><span>Occurrences </span></a>
    </li>
