<html>
<head>
  <title>Dataset occurrences - GBIF</title>
  ...
  <content tag="tabs">
    <div id="tabs">
      <ul>
        ...
        <li class="selected"><a href="<@s.url value='/dataset/${id}/occurrences'/>"><span>Occurrences</span></a></li>
    ...
    <div class="content">
      ...
      <div class="left no_border">
        ...
        <div class="result">
          ...
          <div class="footer">Oaxaca, México | <a href="<@s.url value='/dataset/${id}'/>">Sudamerican Felines</a> |
            Observation
          </div>
        </div>
