<?php 
	...
	if ( !empty ($page['content']['system_main']['term_heading']['term']['field_iso2']['#object']->field_iso2) ) {
		$is_country = TRUE ;
		$country_iso2 = $page['content']['system_main']['term_heading']['term']['field_iso2']['#object']->field_iso2['und'][0]['value'] ;
	}
...
<div id="content"><!-- page.tpl -->
	<article class="results light_pane">
        ...
        <ul class="no_bullets">
        <ul class="no_bullets">
          <li><a href="<?php print ($dataportal_base_url) ?>/dataset<?php if ( $results_exist )  echo '/search?q='.$page['content']['system_main']['term_heading']['term']['#term']->name ; ?>">Publishers and datasets</a></li>
          <li><a href="<?php print ($dataportal_base_url) ?>/country<?php if ( $is_country AND $results_exist )  echo '/'.$country_iso2; ?>">Countries</a></li>
          <li><a href="<?php print ($dataportal_base_url) ?>/occurrence<?php if ( $results_exist )  echo '/search?q='.$page['content']['system_main']['term_heading']['term']['#term']->name ; ?>">Occurrences</a></li>
