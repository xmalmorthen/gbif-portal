  ...
  <script type="text/javascript" src="<?php print ($dataportal_base_url); ?>/js/homepage-map.js"></script>		
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$.getJSON('<?php echo $api_base_url?>/species/search?dataset_key=7ddf754f-d193-4cc9-b351-99906754a03b&limit=1&rank=species&status=accepted&status=DOUBTFUL&callback=?', function (data)
	...
	<link rel="stylesheet" href="<?php print ($base_url); ?>/sites/all/themes/custom/vizz2/css/lastminutefix.css">
</head>
<body class="home">
	<?php print $page; ?>
</body>
