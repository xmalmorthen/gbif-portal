OpenLayers.Popup = OpenLayers.Class({
  ...
  setContentHTML:function(contentHTML) {
    var me = this;
    this.contentHTML =
    '<a class="close" href="#close"></a>' + '<div class="top">' + '<h2><a href="' + this.info.url + '">' +
    this.info.title + '</a></h2>' + '</div>' + '<div class="bottom">' + '<span class="datasets">' + '<p>' +
    this.info.datasets + '</p>' + '<label>datasets</label>' + '</span>' + '<span class="occurrences">' + '<p>' +
    this.info.occurreces + '</p>' + '<label>occurrences</label>' + '</span>' + '<span class="species">' + '<p>' +
    this.info.species + '</p>' + '<label>species</label>' + '</span>' + '</div>';
