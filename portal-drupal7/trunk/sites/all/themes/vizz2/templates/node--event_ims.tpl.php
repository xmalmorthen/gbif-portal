...
<article class="detail">
	...
	<div class="content">
		<div class="header">
			<div class="left">
				<h3><?php echo t('Event details'); ?></h3>
				<?php if ($title): ?>
		...
		<div class="left">
           ...
           <?php if (! empty ( $node->field_audience["und"][0]["value"] )) { ?>		
			 <h3><?php echo t('Number of participants and target audience'); ?></h3>
			 <p><?php print htmlspecialchars_decode(render($content['field_audience'])); ?></p>
           <?php } ?>
           <?php if (! empty ( $node->field_contact["und"][0]["value"] )) { ?>		
             <h3><?php echo t('Contact information'); ?></h3>
			 <p><?php print htmlspecialchars_decode(render($content['field_contact'])); ?></p>
		   <?php } ?>
           <?php if (! empty ( $node->field_resources["und"][0]["value"] )) { ?>		
			 <h3><?php echo t('Resources'); ?></h3>
			 <p><?php print htmlspecialchars_decode(render($content['field_resources'])); ?></p>           
		   <?php } ?>  
           <?php if (! empty ( $node->field_participants["und"][0]["value"] )) { ?>		
			 <h3><?php echo t('Participants'); ?></h3>
			 <p><?php print htmlspecialchars_decode(render($content['field_participants'])); ?></p>           
		   <?php } ?>             
            ...
            <?php } ?>
            <?php if (! empty ( $node->field_language["und"][0]["value"] )) { ?>		
                <h3><?php echo t('Language'); ?></h3>
                <p><?php print render($content['field_language']); ?></p>
            <?php } ?>            
		</div>
		<div class="right">
