...
CREATE TABLE `field_data_field_lastname` (
  ...
  `field_lastname_value` varchar(60) DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 31 (field_lastname)';
...
CREATE TABLE `field_data_field_firstname` (
  ...
  `language` varchar(32) NOT NULL DEFAULT '' COMMENT 'The language for this data item.',
  `delta` int(10) unsigned NOT NULL COMMENT 'The sequence number for this data item, used for multi-value fields',
  `field_firstname_value` varchar(60) DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Data storage for field 30 (field_firstname)';
/*!40101 SET character_set_client = @saved_cs_client */;
